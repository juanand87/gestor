...
$(document).ready(function() {
    ...
    // Cargar funcionarios ya seleccionados (en caso de error de validación)
    <?php if (isset($_POST['funcionarios_ids']) && is_array($_POST['funcionarios_ids'])): ?>
    <?php foreach ($_POST['funcionarios_ids'] as $fid): ?>
